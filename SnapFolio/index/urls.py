...
urlpatterns = [
    ...
    path("articles/", views.articles, name="articles"), # Articles listing page
    path("article-details/", views.article_details, name="article_detail"), # Article details page
    path("article-read/<int:pk>/", views.article_read, name="article_read"), # Single article reading page
